...
const getDefaultGuestEvents = (): TimelineEvent[] => [
  // Suprax medication - 6 days from Oct 6-12
  {
    id: 'guest-1-day1',
    event_type: 'medication',
    ...
    description: 'Taking Suprax - Day 1 of 6',
  },
  {
    id: 'guest-1-day2',
    event_type: 'medication',
    title: 'Suprax (Antibiotic)',
    event_date: new Date(2025, 9, 7, 9, 0, 0).toISOString(),
    medication_name: 'Suprax',
    prescription_start: '2025-10-06',
    prescription_end: '2025-10-12',
    description: 'Taking Suprax - Day 2 of 6',
  },
  {
    id: 'guest-1-day3',
    event_type: 'medication',
    title: 'Suprax (Antibiotic)',
    event_date: new Date(2025, 9, 8, 9, 0, 0).toISOString(),
    medication_name: 'Suprax',
    prescription_start: '2025-10-06',
    prescription_end: '2025-10-12',
    description: 'Taking Suprax - Day 3 of 6',
  },
  {
    id: 'guest-1-day4',
    event_type: 'medication',
    title: 'Suprax (Antibiotic)',
    event_date: new Date(2025, 9, 9, 9, 0, 0).toISOString(),
    medication_name: 'Suprax',
    prescription_start: '2025-10-06',
    prescription_end: '2025-10-12',
    description: 'Taking Suprax - Day 4 of 6',
  },
  {
    id: 'guest-1-day5',
    event_type: 'medication',
    title: 'Suprax (Antibiotic)',
    event_date: new Date(2025, 9, 10, 9, 0, 0).toISOString(),
    medication_name: 'Suprax',
    prescription_start: '2025-10-06',
    prescription_end: '2025-10-12',
    description: 'Taking Suprax - Day 5 of 6',
  },
  {
    id: 'guest-1-day6',
    event_type: 'medication',
    title: 'Suprax (Antibiotic)',
    event_date: new Date(2025, 9, 11, 9, 0, 0).toISOString(),
    medication_name: 'Suprax',
    prescription_start: '2025-10-06',
    prescription_end: '2025-10-12',
    description: 'Taking Suprax - Day 6 of 6',
  },
  {
    id: 'guest-2',
    event_type: 'injury',
